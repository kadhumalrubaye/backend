...
export interface ApiBookmarkBookmark extends CollectionTypeSchema {
  info: {
...
export interface ApiItemItem extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    author: StringAttribute & DefaultTo<'unknown'>;
    source: StringAttribute;
    description: StringAttribute;
    pubDate: DateTimeAttribute & DefaultTo<'2022-09-22T21:02:00.000Z'>;
...
export interface ApiRssSourceRssSource extends CollectionTypeSchema {
  info: {
    singularName: 'rss-source';
    pluralName: 'rss-sources';
    displayName: 'rssSource';
  };
  options: {
    draftAndPublish: false;
  };
...
declare global {
  namespace Strapi {
    interface Schemas {
      ...
      'api::rss-source.rss-source': ApiRssSourceRssSource;
    }
  }
}
